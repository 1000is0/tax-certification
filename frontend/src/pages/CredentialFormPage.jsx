          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell width="140" sx={{ whiteSpace: 'nowrap' }}>구분</TableCell>
                <TableCell sx={{ maxWidth: '250px' }}>인증서명</TableCell>
                <TableCell width="100">만료일</TableCell>
                <TableCell width="100">발급자</TableCell>
                <TableCell width="50">위치</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
