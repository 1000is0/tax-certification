...
function CredentialFormPage() {
  ...
  const getCertType = (oid) => {
    ...
    const certTypeMap = {
      ...
      '1.2.410.200005.1.1.4': '개인 - 은행/보험용', // 전자입찰용 → 은행/보험용 수정
      '1.2.410.200004.5.5.1.3.1': '개인 - 은행/보험용',
      '1.2.410.200004.5.5.1.4.1': '개인 - 은행/보험용',
      '1.2.410.200004.5.5.1.4.2': '개인 - 은행/보험용',
      ...
      // 개인 - 전자세금용 (특수목적용 → 전자세금용 수정)
      '1.2.410.200004.5.1.1.9.2': '개인 - 전자세금용',
      
      // 법인 - 범용 (이미지 참조)
      '1.2.410.200005.1.1.5': '법인 - 범용',
      '1.2.410.200012.1.1.3': '법인 - 범용',
      '1.2.410.200004.5.2.1.1': '법인 - 범용',
      '1.2.410.200004.5.5.1.1': '법인 - 범용',
      '1.2.410.200004.5.3.1.1': '법인 - 범용',
      
      // 법인 - 전자세금용
      '1.2.410.200004.5.1.1.7': '법인 - 전자세금용',
      '1.2.410.200004.5.4.1.2': '법인 - 전자세금용',
      '1.2.410.200004.5.1.1.12.908': '법인 - 전자세금용', // 특수목적용 → 전자세금용 수정
      '1.2.410.200004.5.2.1.5001': '법인 - 전자세금용',
      '1.2.410.200004.5.2.1.6.257': '법인 - 전자세금용',
      '1.2.410.200005.1.1.6.3': '법인 - 전자세금용',
      '1.2.410.200005.1.1.6.4': '법인 - 전자세금용',
      '1.2.410.200005.1.1.6.5': '법인 - 전자세금용',
      '1.2.410.200005.1.1.6.8': '법인 - 전자세금용',
      '1.2.410.200005.1.1.7.1': '법인 - 전자세금용',
          ...
          <Table size="small">
            <TableHead>
              <TableRow>
                ...
                <TableCell width="160" sx={{ whiteSpace: 'nowrap' }}>구분</TableCell>
                <TableCell sx={{ maxWidth: '180px' }}>인증서명</TableCell>
                <TableCell width="110" sx={{ whiteSpace: 'nowrap' }}>만료일</TableCell>
                <TableCell width="100">발급자</TableCell>
                <TableCell width="70">위치</TableCell>
              </TableRow>
            </TableHead>
            <TableBody>
              {certList.map((cert, index) => (
                ...
                >
                  ...
                  <TableCell sx={{ whiteSpace: 'nowrap' }}>{getCertType(cert.oid)}</TableCell>
                  <TableCell sx={{ 
                    maxWidth: '180px',
                    overflow: 'hidden',
                  ...
                  <TableCell sx={{ whiteSpace: 'nowrap' }}>{cert.toDt || '-'}</TableCell>
